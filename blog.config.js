...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'heo', // 锁定默认主题为heo, // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Ifree Space', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '沉迷在摸鱼空间的猫🐱', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ifree.space/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, 摸鱼, 导航,', // 网站关键词 英文逗号隔开
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/Ifree-Space.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
